...
<%@include file="adminHeaderPage.jsp"%>
	<div class="wrapper">
		...
		<div id="error" class="col-sm-12" style="display: none;">
			...
			<div>
					<h1 class="display-4">Show Seat</h1>
			...
			<div class="col-md-12">
				<h1 class="mb-4">Show Seat List</h1>
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<input type="text" class="form-control" id="showid" placeholder="" name="title">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select id="hallName"class="form-control" onchange="selectShowOption()" >
								<option selected disabled>Choose...</option>
							</select>
						</div>
					</div>
					<div class="form-group row">
						<label for="country" class="col-sm-3 col-form-label">Show Time</label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						<label for="country" class="col-sm-3 col-form-label">Seat Type</label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						<label for="startTime" class="col-sm-3 col-form-label">Seat Price</label>
						<div class="col-sm-8">
							<input type="number" class="form-control" id="price" placeholder="Seat Price">
						</div>
					</div>
					
					<div class="form-group row">
						<label for="city" class="col-sm-3 col-form-label">Seat Status</label>
						<div class="col-sm-8">
							<select id="seatStatus" class="form-control" onchange="selectOption()" >
								 <c:forEach items="${seatStatus}" var="seatStatus"> 
									<option value="${seatStatus.seatStatus_id}">${seatStatus.seatStatus_Type}</option>
								 </c:forEach>
							</select>
						</div>
					</div>
						...
						<div class="modal-footer">
							...
							<button type="button"  class="btn btn-primary" id="updateMovieShow">Update Movie Show</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript" src="<c:url value="/static/js/showSeatScript.js" />"></script>
</body>
</html>